...
__all__ = [
    ...
    'SPAUDIOBUFFERINFO', 'SP_VISEME_5', 'SAFT11kHz16BitStereo',
    'SpeechCategoryRecoProfiles', 'IInternetSecurityMgrSite',
    'SPPS_Modifier', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVGetVoices', 'SpeechStreamSeekPositionType',
    'DISPID_SFSOpen', 'SPEI_TTS_AUDIO_LEVEL', 'SPPS_RESERVED2',
    'DISPIDSPRG', 'DISPID_SVVolume', 'SpeechRuleState',
    'SDKLCurrentConfig', 'DISPID_SVIsUISupported', 'ISpRecognizer2',
    'DISPID_SpeechObjectToken', 'SPRULESTATE',
    'SpeechEmulationCompareFlags', 'SpeechVoiceSpeakFlags',
    'SPINTERFERENCE_NOSIGNAL', 'ISpObjectToken', 'SPEI_VISEME',
    'STSF_AppData', 'ISpeechAudioBufferInfo',
    'DISPID_SOTGetAttribute', 'SAFT32kHz16BitMono',
    'SDKLDefaultLocation', 'DISPID_SPRsCount', 'SPRST_ACTIVE_ALWAYS',
    'SPAR_Medium', 'SPCT_DICTATION', 'SGRSTTWord',
    'SRTExtendableParse', 'SPEVENTENUM', 'SITooFast',
    'SSSPTRelativeToEnd', 'SGSEnabled', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFT8kHz8BitMono', 'DISPID_SGRSTsCount', 'SPSMF_SAPI_PROPERTIES',
    'SpNotifyTranslator', 'DISPID_SOTIsUISupported',
    'SAFT12kHz8BitStereo', 'SINoSignal', 'DISPID_SpeechPhraseRule',
    'DISPID_SPPsItem', 'SPPS_Interjection', 'DISPID_SGRsCommit',
    'SLTApp', 'SPBINARYGRAMMAR', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRRAudio', 'SPEI_UNDEFINED', 'SP_VISEME_11',
    'SAFT22kHz16BitStereo', 'DISPID_SRGReset', 'SPSUnknown',
    'ISpeechPhoneConverter', 'SGLexicalNoSpecialChars',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechPhraseProperty',
    'DISPID_SOTSetId', 'SAFT8kHz16BitMono', 'SPPHRASEREPLACEMENT',
    'DISPID_SPPValue', 'SGSDisabled', 'SpShortcut',
    'DISPID_SpeechVoiceEvent', 'DISPID_SPPChildren', 'ISpProperties',
    'SP_VISEME_8', 'ISpeechRecoResult2', 'SpTextSelectionInformation',
    'ISpeechGrammarRule', 'DISPID_SRCCmdMaxAlternates',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPGS_ENABLED', 'DISPID_SPPId',
    'DISPID_SMSALineId', 'SDA_No_Trailing_Space',
    'DISPID_SPRNumberOfElements', 'ISpPhoneticAlphabetConverter',
    'DISPID_SVSpeakStream', 'SRESoundStart', 'DISPID_SPRs_NewEnum',
    'DISPID_SLPType', 'ISpRecoResult', 'SVP_6', '_RemotableHandle',
    'SVSFNLPSpeakPunc', 'DISPID_SPAsItem', 'DISPID_SDKEnumValues',
    'ISpLexicon', 'SAFTDefault', 'STSF_FlagCreate',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SDKCreateKey',
    'SP_VISEME_3', 'SpeechWordType', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechWaveFormatEx', 'SPRST_NUM_STATES',
    'DISPID_SRCCreateResultFromMemory', 'SPWORDLIST',
    'DISPID_SGRsCommitAndSave', 'SPINTERFERENCE', 'SP_VISEME_6',
    'SP_VISEME_19', 'DISPID_SRGId', 'DISPID_SRCPause',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPRsItem',
    'SAFT22kHz8BitMono', 'DISPID_SRCEAudioLevel',
    'DISPID_SPIProperties', 'SPSHORTCUTPAIRLIST', 'SPEI_VOICE_CHANGE',
    'DISPID_SBSWrite', 'SpFileStream', 'DISPID_SOTDataKey',
    'SPCT_COMMAND', 'DISPID_SGRsCount', 'ISpeechGrammarRules',
    'SVSFIsXML', 'ISpeechResourceLoader',
    'DISPID_SPEActualConfidence', 'SPWORD', 'SVEVoiceChange',
    'SPPARTOFSPEECH', 'SAFTExtendedAudioFormat', 'SREAdaptation',
    'SECHighConfidence', 'DISPIDSPTSI_ActiveLength', 'SPFM_NUM_MODES',
    'DISPID_SVAlertBoundary', 'SpeechDiscardType',
    'DISPID_SLGetGenerationChange', 'DISPID_SPRText',
    'SPPS_NotOverriden', 'DISPID_SFSClose', 'eLEXTYPE_APP',
    'DISPID_SRGSetTextSelection', 'SPLO_DYNAMIC', 'SREBookmark',
    'DISPID_SLWsItem', 'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPCLangId',
    'DISPID_SPIEngineId', 'SREAudioLevel', 'DISPID_SWFEFormatTag',
    'SPAUDIOSTATE', 'SITooLoud', 'SpeechGrammarState',
    'ISpeechRecoResult', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE15', 'STCLocalServer',
    'SPGRAMMARWORDTYPE', 'SVP_5', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SLRemovePronunciation', 'ISpeechRecoGrammar',
    'SSSPTRelativeToStart', 'SECFNoSpecialChars', 'DISPID_SRRTLength',
    'ISpeechPhraseInfoBuilder', 'SLOStatic',
    'SpPhoneticAlphabetConverter', 'STCRemoteServer',
    'DISPID_SAFType', 'IEnumSpObjectTokens', 'SRAONone',
    'SPFM_CREATE_ALWAYS', 'SDTAudio', 'DISPID_SRGState',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRAudioInputStream',
    'SAFT32kHz8BitStereo', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SPRuleEngineConfidence', 'SPEI_RESERVED3',
    'ISpeechAudioStatus', 'SDTPronunciation', 'DISPID_SVRate',
    'SAFT32kHz8BitMono', 'IStream', 'SAFT24kHz16BitMono',
    'DISPID_SOTCategory', 'DISPID_SPELexicalForm', 'DISPID_SVSkip',
    'DISPID_SRProfile', 'SpeechAllElements', 'SPSModifier',
    'SPPS_Noncontent', 'SGSExclusive', 'DISPID_SWFEBlockAlign',
    'SPCT_SUB_COMMAND', 'DISPID_SRAudioInput', 'DISPID_SRRPhraseInfo',
    'SDKLCurrentUser', 'DISPID_SVDisplayUI', 'DISPID_SDKDeleteKey',
    'SPEI_PHRASE_START', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SDKSetLongValue', 'ISpRecognizer3', 'SVEAllEvents',
    'DISPID_SASetState', 'DISPID_SLWPronunciations',
    'DISPID_SGRAddState', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SDKGetBinaryValue', 'ISpObjectWithToken',
    'SpeechDisplayAttributes', 'SpeechRecoEvents', 'DISPID_SLPsItem',
    'SVP_7', 'DISPID_SVEViseme', 'SPEI_RECOGNITION',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SpeechRecognizer',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpVoice', 'SREStreamEnd',
    'SAFT16kHz16BitMono', 'ISpDataKey', 'SRAImport',
    'DISPID_SRGDictationUnload', 'SAFTCCITT_ALaw_44kHzMono',
    'SFTInput', 'DISPID_SGRs_NewEnum', 'SREPhraseStart',
    'SpeechRecoProfileProperties', 'DISPID_SRCEEndStream',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTCEnumerateTokens',
    'SVPAlert', 'SVEEndInputStream', 'ISpeechPhraseAlternates',
    'DISPID_SGRSTType', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVSLastBookmark', 'ISpShortcut',
    'SpeechRegistryLocalMachineRoot', 'SPEI_TTS_PRIVATE',
    'SWPKnownWordPronounceable', 'DISPID_SpeechPhraseInfo',
    'SVSFIsFilename', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SOTGetDescription', 'ISpeechPhraseElement',
    'SpeechVisemeFeature', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRRTimes', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPPs_NewEnum', 'SVP_17', 'ISpEventSink',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechObjectTokenCategory',
    'SAFTText', 'DISPIDSPTSI', 'ISpObjectTokenCategory',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPPName',
    'SPBO_TIME_UNITS', 'SPCT_SUB_DICTATION', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechRecoResult', 'SpObjectToken', 'SDTReplacement',
    'DISPID_SRCESoundEnd', 'ISpeechXMLRecoResult',
    'DISPID_SREmulateRecognition', 'SP_VISEME_4', 'DISPID_SRCResume',
    'SPAS_RUN', 'DISPID_SPCIdToPhone', 'DISPID_SRState',
    'DISPID_SRGCmdLoadFromResource', 'ISpGrammarBuilder',
    'DISPID_SpeechCustomStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPWORDTYPE', 'SRSEDone',
    'DISPID_SLGetPronunciations', 'SVP_21',
    'DISPID_SpeechPhraseBuilder', 'SPWF_SRENGINE',
    'SAFT48kHz8BitStereo', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRCEBookmark', 'DISPID_SpeechPhraseReplacement',
    'ISpeechDataKey', 'DISPID_SPIGetDisplayAttributes', 'SITooQuiet',
    'SPAUDIOOPTIONS', 'ISpAudio', 'SPFM_OPEN_READONLY', 'SPAO_NONE',
    'SPPHRASE', 'DISPID_SRGetPropertyString', 'DISPID_SVAudioOutput',
    'SPBO_AHEAD', 'SPEI_PHONEME', 'IEnumString',
    'DISPID_SpeechLexiconProns', 'SGRSTTEpsilon', 'DISPID_SPEsItem',
    'SRARoot', 'eLEXTYPE_PRIVATE13', 'SPLO_STATIC',
    'DISPID_SRSNumberOfActiveRules', 'SAFTADPCM_8kHzStereo',
    'SAFT22kHz16BitMono', 'ISpNotifySink', 'DISPID_SVGetAudioInputs',
    'DISPID_SVEStreamStart', 'SVP_1', 'ISpeechMMSysAudio',
    'DISPID_SPEsCount', 'SWTAdded', 'DISPID_SVGetAudioOutputs',
    'SVESentenceBoundary', 'DISPID_SASState', 'SRCS_Disabled',
    ...
    'DISPID_SCSBaseStream', 'Speech_Max_Pron_Length', 'SBONone',
    'SpInProcRecoContext', 'SASPause', 'SVP_0', 'SPPROPERTYINFO',
    'SVSFIsNotXML', 'SREStreamStart', 'SPINTERFERENCE_TOOFAST',
    'DISPIDSPTSI_SelectionLength', 'SPINTERFERENCE_NONE',
    'SVEPrivate', 'DISPID_SPRulesItem',
    'DISPID_SRCRetainedAudioFormat', 'SINone', 'SREInterference',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVSVisemeId',
    'DISPID_SPRuleConfidence', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTRemove',
    'DISPID_SRCEAdaptation', 'SP_VISEME_9',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRRDiscardResultInfo',
    'SpeechTokenShellFolder', 'DISPID_SPIRule',
    'DISPID_SVSCurrentStreamNumber', 'SPSHT_OTHER',
    'DISPID_SRCERecognition', 'SpeechEngineProperties',
    'DISPID_SPRuleChildren', 'DISPID_SADefaultFormat',
    'DISPID_SRSClsidEngine', 'DISPID_SPIEnginePrivateData',
    ...
    'SPBO_NONE', 'SPINTERFERENCE_TOOQUIET', 'SPSInterjection',
    'DISPID_SRRSpeakAudio', 'SPPS_RESERVED1', 'ISpeechAudio',
    'SRAORetainAudio', 'SPPS_Noun', 'SPEI_RECO_STATE_CHANGE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpMemoryStream', 'SAFTNoAssignedFormat', 'DISPID_SRCState',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SBSSeek',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIStartTime',
    'SPPS_Function', 'Speech_Default_Weight', 'SAFT24kHz8BitStereo',
    'SSFMCreateForWrite', 'DISPID_SRCRetainedAudio', 'ISpeechLexicon',
    'SVSFPersistXML', 'SPXRO_SML', 'DISPID_SpeechPhraseAlternates',
    'SECNormalConfidence', 'SPGS_DISABLED', 'SECFEmulateResult',
    ...
    'DISPID_SVPriority', 'eLEXTYPE_PRIVATE9', 'DISPID_SPAPhraseInfo',
    ...
    'ISpPhoneticAlphabetSelection', 'SPINTERFERENCE_TOOSLOW',
    'SRTReSent', 'SVF_Emphasis', 'DISPID_SOTCGetDataKey', 'SPAR_Low',
    'SpSharedRecognizer', 'DISPID_SRGIsPronounceable',
    'SVEAudioLevel', 'ISpPhoneConverter', 'SVPOver', 'SPRECOSTATE',
    'SPVISEMES', 'SRSActive', 'DISPID_SpeechLexicon',
    'DISPID_SRRAudioFormat', 'SPSHT_EMAIL',
    'DISPID_SRRGetXMLErrorInfo', 'SPPHRASEPROPERTY',
    'SpeechGrammarTagUnlimitedDictation',
    'SAFTCCITT_uLaw_11kHzStereo', 'SDTLexicalForm',
    'SPEVENTSOURCEINFO', 'SPVPRI_OVER', 'SpeechTokenValueCLSID',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRGCmdLoadFromObject', 'SP_VISEME_1',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVEStreamEnd',
    'SPSEMANTICFORMAT', 'SpeechGrammarTagDictation',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechTokenContext',
    'DISPID_SRRGetXMLResult', 'SAFT44kHz16BitStereo',
    'DISPID_SGRSTPropertyName', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechPhraseProperties', 'DISPID_SVSpeakCompleteEvent',
    'SpeechAudioFormatGUIDText', 'DISPID_SMSGetData', 'SGRSTTRule',
    'SPPS_SuppressWord', 'SGRSTTWildcard', 'SRTEmulated',
    'SRADynamic', 'DISPID_SVSpeak', 'STCAll',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVSFVoiceMask',
    'SPFM_OPEN_READWRITE', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRCEPropertyStringChange', 'SREAllEvents',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SVSRunningState',
    'ISpPhraseAlt', 'SSTTDictation', 'DISPID_SMSAMMHandle',
    'SpeechTokenIdUserLexicon', 'SPEI_SR_PRIVATE', 'DISPID_SGRsItem',
    'SpeechCategoryRecognizers', 'SPEI_ADAPTATION',
    'STSF_LocalAppData', 'SPPHRASEELEMENT', 'SAFTADPCM_8kHzMono',
    'DISPID_SPPParent', 'DISPID_SpeechAudioFormat', 'eWORDTYPE_ADDED',
    'SpUnCompressedLexicon', 'SPCS_ENABLED', 'SAFT16kHz16BitStereo',
    'DISPID_SRRSaveToMemory', 'SASClosed', 'DISPID_SGRSRule',
    'SDA_Two_Trailing_Spaces', 'SPINTERFERENCE_NOISE',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechBaseStream', 'DISPID_SDKSetBinaryValue',
    'SDA_One_Trailing_Space', 'SpeechCategoryAudioIn',
    'SAFTCCITT_uLaw_11kHzMono', 'SREPropertyStringChange',
    'DISPID_SpeechRecoResult2', 'SGDSActive', 'SPVPRIORITY',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCreateRecoContext',
    'SVSFParseSapi', 'SDTDisplayText', 'eLEXTYPE_RESERVED8',
    'DISPID_SVEWord', 'SPADAPTATIONRELEVANCE', 'ISpeechLexiconWords',
    'SDTAlternates', 'SPEI_START_SR_STREAM', 'DISPID_SPEDisplayText',
    'SECFIgnoreCase', 'SGPronounciation', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SVSInputWordLength', 'SpeechCategoryVoices',
    'DISPID_SPARecoResult', 'SPVPRI_ALERT', 'SASRun',
    'SPEI_RESERVED2', 'DISPID_SOTCDefault', 'DISPID_SVSPhonemeId',
    'DISPID_SDKSetStringValue', 'DISPID_SPEPronunciation',
    'DISPID_SLPs_NewEnum', 'DISPID_SLPPartOfSpeech', 'SpeechRunState',
    'eLEXTYPE_PRIVATE3', 'SRSEIsSpeaking', 'DISPID_SpeechAudio',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SOTId', 'ISpRecoContext2',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpRecognizer', 'SREStateChange',
    'SAFTCCITT_ALaw_8kHzMono', 'SPPS_Verb', 'DISPID_SVWaitUntilDone',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVResume',
    'SPDKL_LocalMachine', 'ISpeechAudioFormat', 'DISPID_SPIGetText',
    'SPAR_Unknown', 'SpeechVoiceCategoryTTSRate',
    'SPEI_SR_AUDIO_LEVEL', 'SPFM_CREATE', 'ISpeechPhraseRule',
    'ISpeechBaseStream', 'DISPID_SPPEngineConfidence', 'SGDSInactive',
    'SP_VISEME_16', 'SP_VISEME_21', 'SVSFNLPMask',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechCategoryAudioOut', 'DISPID_SPPNumberOfElements',
    'ISpNotifyTranslator', 'SpeechDictationTopicSpelling',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SRADefaultToActive', 'DISPID_SRGetRecognizers', 'SRAExport',
    'DISPID_SGRsDynamic', 'SVP_8', 'DISPID_SVPause',
    'SRERecoOtherContext', 'SPEI_SOUND_START', 'DISPID_SOTsCount',
    'DISPID_SGRAddResource', 'SGRSTTDictation', 'DISPID_SAFGuid',
    'SPSNotOverriden', 'DISPID_SLPsCount', 'SpNullPhoneConverter',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPRuleNumberOfElements',
    ...
    'SPSEMANTICERRORINFO', 'SVSFlagsAsync', 'eLEXTYPE_PRIVATE6',
    'SAFT48kHz16BitStereo', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SGRSTRule', 'ISpeechObjectTokens', 'SpeechInterference',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPAS_CLOSED',
    'DISPID_SpeechDataKey', 'STSF_CommonAppData',
    'SPXMLRESULTOPTIONS', 'UINT_PTR', 'SAFT12kHz16BitStereo',
    'Speech_Max_Word_Length', 'SVP_3', 'DISPID_SpeechGrammarRules',
    'DISPID_SVVoice', 'DISPID_SLPSymbolic',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecoResultTimes',
    'eLEXTYPE_RESERVED9', 'DISPID_SPEs_NewEnum', 'SPEI_RESERVED6',
    ...
    'DISPID_SpeechMMSysAudio', 'SPBO_PAUSE', 'SpPhoneConverter',
    'IInternetSecurityManager', 'SpWaveFormatEx', 'ISpXMLRecoResult',
    'DISPID_SRCEHypothesis', 'SpVoice', 'DISPID_SRRTTickCount',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVEEnginePrivate',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRSetPropertyString',
    'WAVEFORMATEX', 'SPPS_RESERVED4', 'SpeechRecognitionType',
    'SpeechDataKeyLocation', 'DISPID_SOTCreateInstance',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SOTs_NewEnum',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechGrammarRule',
    'DISPID_SPIReplacements', 'DISPID_SOTGetStorageFileName',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SAFGetWaveFormatEx', 'SASStop',
    'SPEI_END_SR_STREAM', 'DISPID_SLAddPronunciation',
    'DISPID_SVEPhoneme', 'DISPID_SGRName', 'DISPID_SLWType',
    'DISPID_SRRRecoContext', 'SPGS_EXCLUSIVE', 'SPCS_DISABLED',
    'SpeechPropertyAdaptationOn', 'SPAR_High',
    'ISpeechRecognizerStatus', 'DISPID_SpeechAudioStatus',
    'ISpResourceManager', 'eLEXTYPE_USER', 'SAFTADPCM_44kHzMono',
    'SAFT44kHz16BitMono', 'DISPID_SGRInitialState',
    'DISPID_SLGenerationId', 'SpAudioFormat',
    'SpeechRegistryUserRoot', 'SpPhraseInfoBuilder',
    'DISPID_SOTsItem', 'SpeechLoadOption', 'SAFT48kHz8BitMono',
    'SPLOADOPTIONS', 'DISPID_SPAStartElementInResult', 'SP_VISEME_14',
    'DISPID_SASFreeBufferSpace', 'SVP_19', 'SPEVENT',
    'DISPID_SPPsCount', 'SpeechRuleAttributes', 'DISPID_SAVolume',
    'SPCONTEXTSTATE', 'DISPID_SRGDictationLoad', 'SpeechUserTraining',
    ...
    'SPDATAKEYLOCATION', 'DISPID_SPRuleParent', 'ISpNotifySource',
    'DISPID_SGRSAddRuleTransition', 'SPWT_LEXICAL',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_RESERVED10',
    'SVSFParseAutodetect', 'SECFIgnoreKanaType', 'SPSFunction',
    'SpeechMicTraining', 'SVP_12', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPRULE',
    'SAFTCCITT_uLaw_44kHzMono', 'SDTRule', 'SAFT11kHz16BitMono',
    'SPSMF_UPS', 'DISPID_SWFEChannels', 'SpResourceManager',
    'SLODynamic', 'DISPID_SAEventHandle',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRStatus',
    'SPLEXICONTYPE', 'SGDisplay', 'ISpeechGrammarRuleState',
    'SRAInterpreter', 'DISPID_SRGCommit', 'DISPID_SVStatus',
    'SpeechCategoryPhoneConverters', 'SpeechBookmarkOptions',
    'ISpeechRecognizer', 'SGRSTTTextBuffer', 'SPWT_PRONUNCIATION',
    'ISpeechPhraseProperties', 'DISPID_SPIGrammarId',
    'SPDKL_CurrentConfig', 'DISPID_SBSRead', 'ISpeechRecoContext',
    'SPRST_INACTIVE', 'DISPID_SPANumberOfElementsInResult', 'SVP_9',
    'SpMMAudioIn', 'ISpeechFileStream', 'eLEXTYPE_PRIVATE10',
    'SPEI_MIN_SR', 'DISPID_SOTCSetId', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPPS_LMA', 'SVP_13', 'DISPID_SASCurrentDevicePosition',
    'SAFT16kHz8BitStereo', 'SpeechRecoContextState',
    'DISPID_SPERequiredConfidence', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRCSetAdaptationData', 'SPEI_SR_BOOKMARK',
    'eLEXTYPE_PRIVATE14', 'SLTUser', 'SVP_11', 'SAFT44kHz8BitMono',
    'SpeechAddRemoveWord', 'SPSNoun', 'SPAO_RETAIN_AUDIO',
    'SPSMF_SRGS_SAPIPROPERTIES', 'LONG_PTR', 'SPAS_STOP',
    'ISpMMSysAudio', 'DISPID_SVEventInterests', 'SPRS_ACTIVE',
    'SAFTCCITT_ALaw_22kHzMono', 'SpMMAudioOut',
    'ISpeechTextSelectionInformation', 'SGLexical',
    'DISPID_SRGetPropertyNumber', 'SINoise', 'SPRECOGNIZERSTATUS',
    ...
    'eLEXTYPE_PRIVATE17', 'SVSFPurgeBeforeSpeak', 'SRESoundEnd',
    'SRERecognition', 'SPTEXTSELECTIONINFO', 'SP_VISEME_15',
    'DISPID_SMSADeviceId', 'SAFT48kHz16BitMono', 'DISPID_SPRuleName',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTGSM610_44kHzMono',
    'SSFMCreate', 'ISpPhrase', 'SVPNormal',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRSTPropertyId',
    'ISpeechLexiconWord', 'eWORDTYPE_DELETED', 'SRATopLevel',
    'SVEBookmark', 'SpeechSpecialTransitionType', 'SPVOICESTATUS',
    'SPEI_FALSE_RECOGNITION', 'SAFT16kHz8BitMono',
    'tagSPPROPERTYINFO', 'DISPID_SPILanguageId',
    'DISPID_SPPConfidence', 'SpSharedRecoContext',
    'DISPID_SOTDisplayUI', 'SAFT22kHz8BitStereo', 'SECLowConfidence',
    'ISpeechPhraseInfo', 'DISPID_SPIAudioSizeBytes',
    'SPDKL_CurrentUser', 'SP_VISEME_17', 'SAFT24kHz8BitMono',
    'SPAS_PAUSE', 'eLEXTYPE_PRIVATE12', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRRTStreamTime', 'DISPID_SLGetWords', 'SP_VISEME_7',
    'DISPID_SABIEventBias', 'SDTAll', 'ISequentialStream',
    'ISpStreamFormat', 'DISPID_SLPLangId', 'DISPID_SRCVoice',
    'SP_VISEME_2', 'DISPID_SPIElements', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSLastBookmarkId', 'SpeechGrammarTagWildcard',
    'DISPID_SLPPhoneIds', 'ISpeechRecoResultTimes',
    'SpeechPropertyResourceUsage', 'SPPHRASERULE', 'SPWAVEFORMATTYPE',
    'SpeechStreamFileMode', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SGRSTsItem', 'DISPID_SPRuleFirstElement',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRGDictationSetState',
    'DISPID_SpeechVoice', 'SRTStandard', 'SRSInactive',
    'SpeechVoiceEvents', 'SBOPause', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGCmdLoadFromMemory',
    'SPWT_DISPLAY', 'SPSERIALIZEDRESULT',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecoGrammar2', 'SpeechVoiceSkipTypeSentence',
    'ISpeechVoiceStatus', 'DISPID_SGRClear', 'SPPS_Unknown',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPRules_NewEnum', 'SP_VISEME_12',
    'SpStreamFormatConverter', 'SPEI_MIN_TTS', 'SP_VISEME_10',
    'SPEI_TTS_BOOKMARK', 'SVF_None', 'SPSLMA', 'SVEWordBoundary',
    'STCInprocServer', 'SpeechLexiconType', 'SPCATEGORYTYPE',
    'SPXRO_Alternates_SML', 'DISPID_SGRSTNextState',
    'STCInprocHandler', 'SRCS_Enabled', 'DISPID_SGRSTWeight',
    'SpeechGrammarRuleStateTransitionType', 'SVSFParseMask',
    'DISPID_SpeechRecoContext', 'DISPID_SPISaveToMemory',
    'SpeechRecognizerState', 'SpeechVoicePriority', 'SWTDeleted',
    'SPWF_INPUT', 'SPSHORTCUTTYPE', '_ISpeechVoiceEvents',
    'DISPID_SPAs_NewEnum', 'SVF_Stressed', 'SPPS_RESERVED3',
    'DISPID_SDKGetlongValue', 'eLEXTYPE_MORPHOLOGY', 'SSTTWildcard',
    'SAFTADPCM_22kHzMono', 'DISPID_SABufferInfo',
    'ISpStreamFormatConverter', 'DISPID_SRDisplayUI',
    'SPDKL_DefaultLocation', 'SDTProperty', 'DISPID_SPACommit',
    'DISPID_SpeechPhraseAlternate',
    'ISpeechGrammarRuleStateTransition', 'ISpRecoCategory',
    'DISPID_SPRulesCount', 'SREPrivate', 'SRSActiveAlways',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRCESoundStart',
    'SpeechVisemeType', 'SVSFParseSsml', 'SpInprocRecognizer',
    'SpeechTokenKeyAttributes', 'DISPID_SRGRules',
    ...
    'SVEStartInputStream', 'SVP_20', 'DISPID_SVEAudioLevel',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SGRsFindRule',
    'SREHypothesis', 'eLEXTYPE_PRIVATE8', 'ISpEventSource',
    'SECFDefault', 'SRSInactiveWithPurge', 'SAFT11kHz8BitStereo',
    'DISPID_SPPFirstElement', 'DISPID_SVSInputWordPosition',
    'SSFMOpenReadWrite', 'SPEI_MAX_SR', 'SPEI_REQUEST_UI',
    'ISpeechPhraseAlternate', 'SP_VISEME_20', 'ISpRecoContext',
    'SAFT8kHz8BitStereo', 'SpeechEngineConfidence',
    'SAFT11kHz8BitMono', 'SpeechAudioFormatType',
    'DISPID_SpeechVoiceStatus', 'DISPID_SVSInputSentenceLength',
    'SpeechAudioState', 'SpeechGrammarWordType', 'SpLexicon',
    'DISPID_SPAsCount', 'SRERequestUI', 'eLEXTYPE_PRIVATE18',
    'DISPID_SDKOpenKey', 'ISpeechPhraseRules', 'DISPID_SWFEExtraData',
    'SPSHORTCUTPAIR', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRCEFalseRecognition', 'SVSFDefault',
    'eLEXTYPE_RESERVED4', 'ISpeechCustomStream',
    'SREPropertyNumChange', '_ISpeechRecoContextEvents', 'ISpStream',
    'ISpeechPhraseProperty', 'Speech_StreamPos_RealTime',
    'DISPID_SDKEnumKeys', 'DISPID_SAStatus', 'SAFT12kHz8BitMono',
    'SPRECOCONTEXTSTATUS', 'ISpeechPhraseElements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_16',
    'SVSFUnusedFlags', 'SpeechFormatType',
    'DISPID_SRGCmdLoadFromFile', 'SVP_10', 'eLEXTYPE_PRIVATE16',
    'eLEXTYPE_PRIVATE20', 'SWPUnknownWordPronounceable',
    'DISPID_SpeechFileStream', 'DISPID_SVSLastStreamNumberQueued',
    'SITooSlow', 'SPBOOKMARKOPTIONS', 'SP_VISEME_13',
    'eLEXTYPE_PRIVATE4', 'DISPID_SGRSAddSpecialTransition',
    'SpeechPartOfSpeech', 'DISPID_SVSLastResult',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPSSuppressWord',
    'SPRST_ACTIVE', 'SpeechWordPronounceable', 'DISPID_SRCBookmark',
    'DISPID_SpeechMemoryStream', 'DISPID_SABIBufferSize',
    'SpeechAudioVolume', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechPhraseRules', 'SPRECORESULTTIMES',
    'DISPID_SABufferNotifySize', '_SPAUDIOSTATE', 'SPRS_INACTIVE',
    'SP_VISEME_18', 'SAFTGSM610_11kHzMono', 'SPEI_SOUND_END',
    ...
    'SECFIgnoreWidth', 'SPFILEMODE', 'DISPID_SGRSTPropertyValue',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVAudioOutputStream',
    'DISPID_SRGetFormat', 'eLEXTYPE_RESERVED6', 'SRTSMLTimeout',
    'SPEI_MAX_TTS', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPRFirstElement', 'ISpeechRecoResultDispatch',
    'SRTAutopause', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SGDSActiveUserDelimited', 'SPEI_WORD_BOUNDARY', 'SPGRAMMARSTATE',
    'SVEViseme', 'SPEI_RESERVED5', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRSAudioStatus', 'DISPID_SRRecognizer',
    'DISPID_SVGetProfiles', 'SAFTNonStandardFormat', 'SpMMAudioEnum',
    'SPEI_RESERVED1', 'DISPID_SpeechLexiconWords',
    'SPEI_INTERFERENCE', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTADPCM_11kHzMono', 'SVP_15', 'DISPID_SRCEStartStream',
    'SAFT32kHz16BitStereo', 'DISPID_SGRSTText',
    'ISpeechPhraseReplacements', 'DISPIDSPTSI_ActiveOffset',
    'SP_VISEME_0', 'Speech_StreamPos_Asap', 'SPSVerb',
    'SPSHT_Unknown', 'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE1',
    'SPCT_SLEEP', 'DISPID_SLWLangId', 'eLEXTYPE_PRIVATE5', 'SVP_14',
    'SPEI_RECO_OTHER_CONTEXT', 'SPWORDPRONUNCIATION',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SLWsCount', 'DISPID_SOTCId',
    'SVP_4', 'tagSTATSTG', 'DISPID_SpeechGrammarRuleState',
    'SPSHT_NotOverriden', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRIsShared', 'ISpeechPhraseReplacement', 'SVP_2',
    'SpCustomStream', 'DISPID_SAFSetWaveFormatEx',
    'ISpeechLexiconPronunciation', 'DISPID_SVEBookmark',
    'SDKLLocalMachine', 'SpeechTokenKeyFiles',
    ...
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRId', 'SSTTTextBuffer',
    'SPAUDIOSTATUS', 'SpeechAudioFormatGUIDWave', 'DISPID_SGRsAdd',
    'DISPID_SLWWord', 'SpeechTokenKeyUI',
    'DISPID_SpeechPhoneConverter', 'ISpeechObjectToken'
]
